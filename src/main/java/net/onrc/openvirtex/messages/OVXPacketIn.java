    ...
    public void virtualize(final PhysicalSwitch sw) {
        ...
        if (match.get(MatchField.ETH_TYPE) == EthType.IPv4
            ...
            if (match.get(MatchField.ETH_TYPE) == EthType.ARP) {
                // ARP packet
                // ksyang -> do not need to process arp packets (that contains multicasts)
                /*
                ...
                */
                ...
                try {
                    ...
                    if(ip.getDestinationAddress() == 0xffffffff){
                        return;
                    }

                    if((ip.getDestinationAddress() & 0xF0000000) == 0xE0000000){
                        return;
                    }
