...
public final class PhysicalNetwork extends
    ...
    private static PhysicalNetworkScheduler scheduler;
    private static Logger log = LogManager.getLogger(PhysicalNetwork.class.getName());
    private final BitSetIndex edgeStatCounter;
    ...
    private PhysicalNetwork() {
        ...
        this.edgeStatCounter = new BitSetIndex(BitSetIndex.IndexType.edgePORT_ID);
    ...
    public static PhysicalNetworkScheduler getScheduler(){
    	if(PhysicalNetwork.scheduler == null){
    		PhysicalNetwork.scheduler = new PhysicalNetworkScheduler(1000); // (modified this to be at 1 s)
    	}
    	return PhysicalNetwork.scheduler;
    }
    ...
    public long getEdgeStatCounter() throws IndexOutOfBoundException {
        return this.edgeStatCounter.getNewIndex();
    }
}
