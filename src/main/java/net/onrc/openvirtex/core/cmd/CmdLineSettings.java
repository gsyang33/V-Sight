...
public class CmdLineSettings {
    ...
    @Option(name = "--flow-stats-refresh", usage = "Sets what interval to poll statistics with")
    private Integer flowStatsRefresh = CmdLineSettings.DEFAULT_STATS_REFRESH;
    
    @Option(name = "--port-stats-refresh", usage = "Sets what interval to poll statistics with")
    private Integer portStatsRefresh = CmdLineSettings.DEFAULT_STATS_REFRESH;
     ...
     */
    public Integer getFlowStatsRefresh() {
        return this.flowStatsRefresh;
    }
    
    /**
     * Gets the value (in seconds) the flow statistics are queried.
     *
     * @return the statistics refresh period
     */
    public Integer getPortStatsRefresh() {
        return this.portStatsRefresh;
    }
