...
public class OpenVirteXController implements Runnable {
    ...
    private Integer flowStatsRefresh;
    
    private Integer portStatsRefresh;
    ...
    public OpenVirteXController(CmdLineSettings settings) {
        ...
        this.flowStatsRefresh = settings.getFlowStatsRefresh();
        this.portStatsRefresh = settings.getPortStatsRefresh();
        ...
        //ksyang: I modify the keepAliveTIme from 5 to 15
        this.clientThreads = new OrderedMemoryAwareThreadPoolExecutor(
                nClientThreads, 1048576, 1048576, 15, TimeUnit.SECONDS);
        this.serverThreads = new OrderedMemoryAwareThreadPoolExecutor(
                nServerThreads, 1048576, 1048576, 15, TimeUnit.SECONDS);
